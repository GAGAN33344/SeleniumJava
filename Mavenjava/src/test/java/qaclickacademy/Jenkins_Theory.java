...
*  Download the Generic java package(.war) file, now i will open the terminal and give
   ...
   Pick from local machine, first i will click on new item on left top side,Enter name,
    ...
    execution under Invole top-level Maven targets.
    ...
    we will see one file in maven project target folder, file name is testng-results.xml
    all our results basically in generated in xml file format, now testng have provided one 
